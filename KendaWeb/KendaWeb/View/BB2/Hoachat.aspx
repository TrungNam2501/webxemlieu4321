<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Hoachat.aspx.cs" Inherits="KendaWeb.View.BB2.Hoachat" %>
    ...
    <div style="padding: 0 20px;">
        <div class="container" style="height: 70px; width: 100%">
            <div class="BBflex">
                ...
                <asp:Button ID="btnXemLieu" runat="server" Text="Xem liệu" OnClick="btnXemLieu_Click" CssClass="btn btn-danger" Style="margin-right: 10px" OnClientClick="showLoading();" />
                <asp:Button ID="btnExcelLrplan" runat="server" CssClass="btn btn-success" OnClick="btnExcelLrplan_Click" Style="margin-right: 10px" Text="Xuất excel" />
                ...
                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Image/search-more.png" Width="50px" Height="50px" OnClick="ImageButton1_Click" />
            </div>
        </div>
        <div class="container" style="height: 35px; width: 100%">
            &nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label9" runat="server" Text="Bảng xem mes hóa chất chạy được" Font-Size="25px"></asp:Label>
            <asp:Label ID="Label3" runat="server" Text="(LR_plan)" Font-Size="25px" Font-Bold="true"></asp:Label>
        </div>

        <div style="margin: 0 30px; height: 75vh; overflow: auto; border: 5px solid black;">
            <asp:GridView ID="gvKQHCMoi" OnRowCommand="gvKQHCMoi_RowCommand" runat="server" CssClass="table table-responsive table table-responsive table-bordered"
                ...
                <Columns>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderText="Xem <br> các chất <br> cần quét">
                        <ItemTemplate>
                    ...
                    <asp:BoundField DataField="Plan_Batch" ItemStyle-HorizontalAlign="Center" HeaderText="Plan_Batch" />
                    ...
                    <asp:BoundField DataField="Real_Num" ItemStyle-HorizontalAlign="Center" HeaderText="Real Num" />
                     <asp:BoundField DataField="sokgdieudong" ItemStyle-HorizontalAlign="Center" HeaderText="Điều động(KG)" />
                    <asp:BoundField DataField="Real_Weight" ItemStyle-HorizontalAlign="Center" HeaderText="Thực tế(KG)" />
                        ...
                        <table id="tbl_gvInHC1" style="background-color: gray; margin-left: auto; margin-right: auto; box-shadow: 0 0 10px 2px gray; border-radius: 10px; width: 95%; height: 70%;">
                            <tr>
                                <td style="height: 40px; padding-left: 10px; color: black;">
                                    ...
                                    <asp:Button ID="btnExcelLrRecipe" runat="server" Text="Xuất Excel" OnClick="btnExcelLrRecipe_Click" Style="margin-right: 10px; height: 33px; width: 75px; text-align: center; padding: 0; float: right;" class="btn btn-info" />
                                    ...
                                    <div style="height: 100%; width: 100%; overflow: hidden; overflow: auto; border-style: solid;">
                                        ...
                                        <asp:GridView ID="gvInHC" runat="server" OnRowCommand="gvInHC_RowCommand"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderText="Xem <br> Dữ liệu <br> Mở bồn HC">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ImageUrl="../../image/R.png" Width="60px" Height="25px" OnClientClick="showLoading();" CommandName="btnLRbarcodeLog" CommandArgument='<%# Eval("Material_Code")+","+Eval("Material_Name")+","+Eval("Plan_Id")%>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                ...
                <tr>
                    <td>
                        <table id="tbl_gvOutHC1" style="background-color: gray; margin-left: auto; margin-right: auto; box-shadow: 0 0 10px 2px gray; border-radius: 10px; width: 95%; height: 70%;">
                            <tr>
                                <td style="height: 40px; padding-left: 10px; color: black;">
                                    <asp:Label ID="Label11" runat="server" Text="Bảng xem số bao hóa chất sản xuất được của mes" Font-Size="25px"></asp:Label>
                                    <asp:Label ID="Label5" runat="server" Text="(LR_lot)" Font-Size="25px" Font-Bold="true"></asp:Label>
                                    <button type="button" class="btn btn-danger" style="float: right; margin-right: 10px" onclick="closeShowOutHC();">X</button>
                                    <asp:Button ID="btnExcelLrLot" runat="server" OnClick="btnExcelLrLot_Click" Text="Xuất excel" Style="margin-right: 10px; height: 33px; width: 75px; text-align: center; padding: 0; float: right;" class="btn btn-info" />
                                </td>
                            </tr>
                            <tr>
                                <td style="background-color: gainsboro; vertical-align: top; padding: 10px; max-width: 1080px">
                                    <div style="height: 100%; width: 100%; overflow: hidden; overflow: auto; border-style: solid;">
                                        ...
                                        <asp:GridView ID="gvOutHC" runat="server" OnRowCommand="gvOutHC_RowCommand"
                                            CssClass="table table-responsive table table-responsive table-bordered"
                                            Style="width: 150%; border: groove; background-color: white; font-size: 16px; font-weight: bold; font-family: Arial;" AutoGenerateColumns="false">
                                            <HeaderStyle CssClass="header_girdview" />
                                            <RowStyle CssClass="row_css" />
                                            <Columns>
                                                <asp:BoundField DataField="Plan_Id" ItemStyle-HorizontalAlign="Center" HeaderText="Plan Id" />
                                                <asp:BoundField DataField="Equip_Code" ItemStyle-HorizontalAlign="Center" HeaderText="Equip Code" />
                                                <asp:BoundField DataField="Serial_Num" ItemStyle-HorizontalAlign="Center" HeaderText="Serial Num" />
                                                <asp:BoundField DataField="Prd_date" ItemStyle-HorizontalAlign="Center" HeaderText="Prd date" />
                                                <asp:BoundField DataField="Real_weight" ItemStyle-HorizontalAlign="Center" HeaderText="Real weight" />
                                                <asp:BoundField DataField="Real_Error" ItemStyle-HorizontalAlign="Center" HeaderText="Real Error" />
                                                <asp:BoundField DataField="Waste_Time" ItemStyle-HorizontalAlign="Center" HeaderText="Waste Time" />
                                                <asp:BoundField DataField="Net_Weight" ItemStyle-HorizontalAlign="Center" HeaderText="Net Weight" />

                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderText="Xem <br> Dữ liệu <br> Cân bao HC">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ImageUrl="../../image/R.png" Width="60px" Height="25px" OnClientClick="showLoading();" CommandName="btnLrWeight" CommandArgument='<%# Eval("Plan_Id")+","+ Eval("Serial_Num")%>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
        ...
        <div>
            <table id="tbl_gvInBaoHC" style="display: none; position: fixed; top: 0; left: 0; right: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5);">
                <tr>
                    <td>
                        <table id="tbl_gvInBaoHC1" style="background-color: gray; margin-left: auto; margin-right: auto; box-shadow: 0 0 10px 2px gray; border-radius: 10px; width: 95%; height: 70%;">
                            <tr>
                                <td style="height: 40px; padding-left: 10px; color: black;">
                                    <asp:Label ID="Label12" runat="server" Text="Bảng xem chi tiết cân hóa chất của mỗi bao" Font-Size="25px"></asp:Label>
                                    <asp:Label ID="Label6" runat="server" Text="(LR_weigh)" Font-Size="25px" Font-Bold="true"></asp:Label>
                                    <button type="button" class="btn btn-danger" style="float: right; margin-right: 10px" onclick="closeShowInBaoHC();">X</button>
                                    <asp:Button ID="btnExcellrweight" runat="server" Text="Xuất excel" OnClick="btnExcellrweight_Click" Style="margin-right: 10px; height: 33px; width: 75px; text-align: center; padding: 0; float: right;" class="btn btn-info" />
                                    <%--<button style="margin-right: 10px; height: 33px; width: 75px; text-align: center; padding: 0; float:right;" class="btn btn-info back">Quay lại</button>--%>
                                </td>
                            </tr>
                            <tr>
                                <td style="background-color: gainsboro; vertical-align: top; padding: 10px; max-width: 1080px">
                                    <div style="height: 100%; width: 100%; overflow: hidden; overflow: auto; border-style: solid;">
                                        ...
                                        <asp:GridView ID="gvInBao" runat="server"
                                            CssClass="table table-responsive table table-responsive table-bordered"
                                            Style="width: 150%; border: groove; background-color: white; font-size: 16px; font-weight: bold; font-family: Arial;" AutoGenerateColumns="false">
                                            <HeaderStyle CssClass="header_girdview" />
                                            <RowStyle CssClass="row_css" />
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Weight_ID" ItemStyle-HorizontalAlign="Center" HeaderText="Weight ID" />
                                                <asp:BoundField DataField="Material_Code" ItemStyle-HorizontalAlign="Center" HeaderText="Material Code" />
                                                <asp:BoundField DataField="Real_Weight" ItemStyle-HorizontalAlign="Center" HeaderText="Real_Weight" />
                                                <asp:BoundField DataField="Real_Error" ItemStyle-HorizontalAlign="Center" HeaderText="Real Error" />
                                                <asp:BoundField DataField="Over_Weight" ItemStyle-HorizontalAlign="Center" HeaderText="Over Weight" />
                                                <asp:BoundField DataField="Waste_Time" ItemStyle-HorizontalAlign="Center" HeaderText="Waste Time" />
                                                <asp:BoundField DataField="Weight_Time" ItemStyle-HorizontalAlign="Center" HeaderText="Weight Time" />
                ...
                <tr>
                    <td>
                        <table id="tbl_BarcodeLog1" style="background-color: gray; margin-left: auto; margin-right: auto; box-shadow: 0 0 10px 2px gray; border-radius: 10px; width: 95%; height: 70%;">
                            <tr>
                                <td style="height: 40px; padding-left: 10px; color: black;">
                                    <asp:Label ID="Label13" runat="server" Text="Bảng xem chi tiết mở bồn hóa chất trong ngày chạy mes " Font-Size="25px"></asp:Label>
                                    <asp:Label ID="Label7" runat="server" Text="(LR_BarcodeLog)" Font-Size="25px" Font-Bold="true"></asp:Label>
                                    <button type="button" class="btn btn-danger" style="float: right; margin-right: 10px" onclick="closeShowBarcodeLog();">X</button>
                                    <asp:Button ID="btnExcelBarcodelog" runat="server" Text="Xuất excel" OnClick="btnExcelBarcodelog_Click"  Style="margin-right: 10px; height: 33px; width: 75px; text-align: center; padding: 0; float: right;" class="btn btn-info" />
                                    <%--<button style="margin-right: 10px; height: 33px; width: 75px; text-align: center; padding: 0; float:right;" class="btn btn-info back">Quay lại</button>--%>
                                </td>
                            </tr>
                            <tr>
                                <td style="background-color: gainsboro; vertical-align: top; padding: 10px; max-width: 1080px">
                                    <div style="height: 100%; width: 100%; overflow: hidden; overflow: auto; border-style: solid;">
                                        ...
                                        <asp:GridView ID="gvBarcodeLog" runat="server" OnRowCommand="gvBarcodeLog_RowCommand"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="Equip_Code" ItemStyle-HorizontalAlign="Center" HeaderText="Equip Code" />
                                                <asp:BoundField DataField="Scan_Time" ItemStyle-HorizontalAlign="Center" HeaderText="Scan Time" />
                                                <asp:BoundField DataField="Scan_Bar" ItemStyle-HorizontalAlign="Center" HeaderText="Scan Bar" />
                                                <asp:BoundField DataField="Material" ItemStyle-HorizontalAlign="Center" HeaderText="Material" />
                                                <asp:BoundField DataField="Bin" ItemStyle-HorizontalAlign="Center" HeaderText="Bin" />
                                                <asp:BoundField DataField="Scan_State" ItemStyle-HorizontalAlign="Center" HeaderText="Scan_State" />
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderText="Xem <br> chi tiết <br> tem vàng">
                                                    <ItemTemplate>
                                                        <asp:ImageButton ImageUrl="../../image/R.png" Width="60px" Height="25px" OnClientClick="showLoading();" CommandName="btnMes2row" CommandArgument='<%# Eval("Scan_Bar")%>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                        ...
                        <table id="tbl_scanBar1" style="background-color: gray; margin-left: auto; margin-right: auto; box-shadow: 0 0 10px 2px gray; border-radius: 10px; width: 95%; height: 70%;">
                            <tr>
                                <td style="height: 40px; padding-left: 10px; color: black;">
                                    ...
                                    <asp:Button ID="btnExcelMes2RawMaterial" runat="server" OnClick="btnExcelMes2RawMaterial_Click" Text="Xuất Excel" Style="margin-right: 10px; height: 33px; width: 75px; text-align: center; padding: 0; float: right;" class="btn btn-info" />
                                    <%--<button style="margin-right: 10px; height: 33px; width: 75px; text-align: center; padding: 0; float:right;" class="btn btn-info back">Quay lại</button>--%>
                                </td>
                            </tr>
                            <tr>
