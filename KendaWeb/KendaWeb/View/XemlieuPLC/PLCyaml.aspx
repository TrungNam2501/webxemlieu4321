<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PLCyaml.aspx.cs" Inherits="KendaWeb.View.XemlieuPLC.PLCyaml" %>
...
<div style="padding: 0 20px;">
    <div class="container" style="height: 70px; width: 100%">
        <div class="BBflex">
            <asp:Label ID="Label1" runat="server" Text="Mes YAML:" ForeColor="Red" Font-Bold="True" Font-Size="24pt"></asp:Label>
        ...
        <div style="margin: 0 30px; height: 80vh; overflow: auto; border: 5px solid black;">
            <asp:GridView ID="gvMesid" OnRowCommand="gvMesid_RowCommand" runat="server" CssClass="table tablehaile table-hover table-responsive table table-responsive table-bordered" Style="border: double; background-color: white; font-size: 16px; font-weight: bold; font-family: Arial" AutoGenerateColumns="false">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Plan_Id" ItemStyle-CssClass="jsbang" ItemStyle-HorizontalAlign="Center" HeaderText="Mesid" HtmlEncode="false" />
                    <asp:BoundField DataField="Recipe_Code" ItemStyle-CssClass="jsbang" ItemStyle-HorizontalAlign="Center" HeaderText="Mã keo" HtmlEncode="false" />
                    <asp:BoundField DataField="Equip_ID" ItemStyle-CssClass="jsbang" ItemStyle-HorizontalAlign="Center" HeaderText="Máy" HtmlEncode="false" />
                    <asp:BoundField DataField="Plan_Num" ItemStyle-CssClass="jsbang" ItemStyle-HorizontalAlign="Center" HeaderText="Số mẻ cài đặt" HtmlEncode="false" />
                    <asp:BoundField DataField="Write_Time" ItemStyle-CssClass="jsbang" ItemStyle-HorizontalAlign="Center" HeaderText="Giờ tạo Mes" HtmlEncode="false" />
                    <asp:BoundField DataField="P_Date" ItemStyle-CssClass="jsbang" ItemStyle-HorizontalAlign="Center" HeaderText="Ngày tạo Mes" HtmlEncode="false" />
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" HeaderText="Xem <br> dữ liệu PLC">
                        <ItemTemplate>
                            ...
                            <asp:ImageButton ImageUrl="../../image/R.png" OnClientClick="showLoading();" Width="60px" Height="25px" CommandName="btnIn" CommandArgument='<%# Eval("Plan_Id")+","+Eval("Recipe_Code")+","+Eval("P_Date")%>' runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
