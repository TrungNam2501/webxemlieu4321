<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ApiBB.aspx.cs" Inherits="KendaWeb.View.XemLieuBB.ApiBB" %>
       ...
       <div class="container" style="height: 70px; width: 100%">
           <div class="BBflex">
               ...
               <asp:DropDownList ID="drMay" runat="server" CssClass="form-control" Style="width: 150px; text-align: center; margin-right: 10px">
                   ...
                   <asp:ListItem Value="08"> Máy 08 </asp:ListItem>
                   <%--<asp:ListItem Value="tatca">Xem tất cả </asp:ListItem>--%>
               </asp:DropDownList>
               <asp:TextBox ID="txtFromDay" runat="server" autocomplete="off" CssClass="form-control" placeholder="---Từ ngày---" Style="width: 150px; margin-right: 10px; text-align: center; font-family: Arial; font-size: 14px; font-weight: bold; color: #000000" />
               <asp:TextBox ID="txtToday" runat="server" autocomplete="off" CssClass="form-control" placeholder="---Đến ngày---" Style="width: 150px; margin-right: 10px; text-align: center; font-family: Arial; font-size: 14px; font-weight: bold; color: #000000" />
                           ...
                           <tr>
                               <td style="background-color: gainsboro; vertical-align: top; padding: 10px; max-width: 1080px">
                                   <div style="height: 100%; width: 100%; overflow: hidden; overflow: auto; border-style: solid;">
                                       ...
                                       <asp:GridView ID="gvInTem" runat="server"
                                           ...
                                           <Columns>
                                               ...
                                               <asp:BoundField DataField="pallet_no" ItemStyle-HorizontalAlign="Center" HeaderText="Mã Palet" />
                                                <asp:BoundField DataField="some_sx" ItemStyle-HorizontalAlign="Center" HeaderText="Số mẻ" />
                                           </Columns>
                                       </asp:GridView>
                                   </div>
                               </td>
